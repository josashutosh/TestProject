...
var Demo = function () {
    ...
    var handleTheme = function () {
        ...
        if ($('.sidebar-pos-option').attr("disabled") === false) {
            $('.sidebar-pos-option', panel).val(Society.isRTL() ? 'right' : 'left');
        }
        ...
        var setColor = function (color) {
            var color_ = (Society.isRTL() ? color + '-rtl' : color);
    ...
    var setThemeStyle = function(style) {
        ...
        file = (Society.isRTL() ? file + '-rtl' : file);

        $('#style_components').attr("href", Society.getGlobalCssPath() + file + ".css");
