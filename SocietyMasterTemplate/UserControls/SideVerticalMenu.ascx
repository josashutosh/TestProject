<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SideVerticalMenu.ascx.cs" Inherits="EsquareMasterTemplate.UserControls.SideVerticalMenu" %>

	<div id="sidebar-wrapper" class="page-sidebar-wrapper" >
		<!-- DOC: Set data-auto-scroll="false" to disable the sidebar from auto scrolling/focusing -->
		<!-- DOC: Change data-auto-speed="200" to adjust the sub menu slide up/down speed -->
		<div class="page-sidebar navbar-collapse collapse" id="VerticalsideMenu" runat="server">
			<!-- BEGIN SIDEBAR MENU -->
