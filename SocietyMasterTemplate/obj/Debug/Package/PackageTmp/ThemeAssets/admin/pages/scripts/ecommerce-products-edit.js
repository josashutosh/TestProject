var EcommerceProductsEdit = function () {
            ...
            init: {
                ...
                FileUploaded: function(up, file, response) {
                    ...
                    if (response.result && response.result == 'OK') {
                        ...
                        Society.alert({type: 'danger', message: 'One of uploads failed. Please retry.', closeInSeconds: 10, icon: 'warning'});
                    }
                },
         
                Error: function(up, err) {
                    Society.alert({type: 'danger', message: err.message, closeInSeconds: 10, icon: 'warning'});
                }
            }
        });
    ...
    var initComponents = function () {
        ...
        $(".datetime-picker").datetimepicker({
            ...
            autoclose: true,
            todayBtn: true,
            pickerPosition: (Society.isRTL() ? "bottom-right" : "bottom-left"),
            minuteStep: 10
        });
