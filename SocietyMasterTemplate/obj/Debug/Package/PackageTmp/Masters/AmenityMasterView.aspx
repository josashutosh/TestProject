<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Masterview.Master" AutoEventWireup="true" CodeBehind="AmenityMasterView.aspx.cs" Inherits="EsquareMasterTemplate.Masters.AmenityMasterView" %>
...
<script type="text/javascript" language="javascript">
    ...
    function chkSelectAll() {
        ...
        var rowscount = document.getElementById('Main_lvAmenitymstr').rows.length;

        for (var i = 0; i <= rowscount - 3; i++) {
            var chkselect = document.getElementById('MainContent_lvAmenitymstr_ctrl' + i + '_chkselect_' + i);
            var chkAll = document.getElementById('MainContent_lvAmenitymstr_chkAll');
            var hdnID = document.getElementById('MainContent_lvAmenitymstr_ctrl' + i + '_hdnamenityID_' + i);
    ...
    {
        var chkAll = document.getElementById('MainContent_lvAmenitymstr_chkAll');
        var hdnID = document.getElementById(ID.replace('chkselect', 'hdnamenityID'));
        var hdnAllID = document.getElementById('<%=hdnAllID.ClientID %>');
...
<!-- BEGIN PAGE HEADER-->
    ...
    <div class="page-bar">
       <ul class="page-breadcrumb">
            ...
            <li><a href="../Masters/AmenitymasterView.aspx">Amenities Information View</a> </li>
        </ul>
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="control-label col-md-3">
                                        Search</label>
                                    <div class="col-md-9">
                                        <asp:DropDownList ID="drpBuildingid" class="select2me form-control input-medium" runat="server">
                                      </asp:DropDownList>
                                    ...
                                    </span>Enter Building Name </p> </span>
                ...
                <div class="portlet light bordered form-fit">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-user font-blue-hoki"></i><span class="caption-subject font-blue-hoki bold uppercase">
                                Amenities Information View</span> <span class="caption-helper"></span>
                        </div>
                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="table-responsive">
                            <asp:ListView ID="lvAmenitymstr" class="table-responsive" runat="server" GroupPlaceholderID="groupPlaceHolder1"
                        ItemPlaceholderID="itemPlaceHolder1" 
                                OnPagePropertiesChanging="OnPagePropertiesChanging" >
                        <LayoutTemplate>
                            <table id="Main_lvAmenitymstr" class="table table-striped table-bordered table-hover">
                             <thead>
                                 <tr>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:DataPager ID="DataPager1" runat="server" PagedControlID="lvAmenitymstr" QueryStringField="page" PageSize="20">
                                            <Fields>
                        ...
                        <ItemTemplate>
                           <td>
                            ...
                            <td>
                            <asp:HiddenField ID="hdnamenityID" Value='<%#Eval("AminityId") %>' runat="server" />
                                
                                <%# Eval("Name")%>
                            </td>
                            
                            <td>
                                <asp:HyperLink ID="HyperLink1" class="btn btn-success btn-sm " NavigateUrl='<%#"~/Masters/AmenityMaster.aspx?PId=9&amp;AmenityId=" + Eval("[AminityId]").ToString()%>' runat="server">Edit</asp:HyperLink>
