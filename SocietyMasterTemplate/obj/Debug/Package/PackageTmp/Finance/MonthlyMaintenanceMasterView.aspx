<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Masterview.Master" AutoEventWireup="true" CodeBehind="MonthlyMaintenanceMasterView.aspx.cs" Inherits="EsquareMasterTemplate.Masters.MonthlyMaintenanceMasterView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li><a href="../Masters/MonthlyMaintenanceMasterView.aspx">Monthly Maintenance Information View</a> </li>
        </ul>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        ...
                                        <span class="caption-helper" style="display: inline !important; padding: 9px">Delete multiple record</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="btn-group pull-right">
                        ...
                        <div class="table-responsive">
                            <asp:ListView ID="lvMainMstr" class="table-responsive" runat="server" GroupPlaceholderID="groupPlaceHolder1"
                                ...
                                <ItemTemplate>
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnmainmstrID" Value='<%# Eval("MonthlyMaintenaceId")%>' runat="server" />
                                       <%# Eval("PropertyType")%>
                                    </td>
                                    <td>
                                        <%# Eval("CalculationMethod")%>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:HyperLink ID="HyperLink1" class="btn green btn-sm" NavigateUrl='<%#"~/Masters/MonthlyMaintenanceMaster.aspx?PId=4&amp;PageID=" + Eval("[MonthlyMaintenaceId]").ToString()%>' runat="server">Edit</asp:HyperLink>
