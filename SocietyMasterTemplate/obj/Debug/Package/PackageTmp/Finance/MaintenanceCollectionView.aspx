<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Masterview.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="MaintenanceCollectionView.aspx.cs"
    Inherits="EsquareMasterTemplate.Finance.MaintenanceCollectionView" %>
        ...
        function getFlatsbyBuildname() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#<%=drpFlatID.ClientID %> option').remove();
                    $("#<%=drpFlatID.ClientID %>").multiselect('rebuild');
                    if (Result.length > 0) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>Maintenance Collection View </li>
        </ul>
            ...
            <div class="portlet light bg-inverse">
                ...
                <div style="" class="portlet-body form">
                    ...
                    <div class="Maincollection">
                        <div class="form-body">
                            <span runat="server" id="filtergroup1" clientidmode="Static" >
                            ...
                            <div class="form-group float input-medium">
                                <label class="control-label" style="width: 200px !important">
                                    building Name</label>
                                <asp:DropDownList ID="drpBuildingid" class="select2me form-control" runat="server">
                                </asp:DropDownList>
                            </div>
                            <!--/span-->
                    ...
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-user font-blue-hoki"></i><span class="caption-subject font-blue-hoki bold uppercase">
                                Maintenance Collection View</span> <span class="caption-helper"></span>
                        </div>
                    </div>
