var FormImageCrop = function () {
    ...
    var demo5 = function() {
        ...
        function initJcrop()//{{{
        {
          ...
          $('#demo5').Jcrop({
            ...
            Society.updateUniform('#can_click,#can_move,#can_size');

            $('#ar_lock,#size_lock,#bg_swap').attr('checked',false);
            Society.updateUniform('#ar_lock,#size_lock,#bg_swap');
        ...
        function releaseCheck()
        {
          ...
          Society.updateUniform('#can_click');
        };
    ...
    return {
        ...
        init: function () {
            ...
            Society.addResizeHandler(handleResponsive);
            handleResponsive();
