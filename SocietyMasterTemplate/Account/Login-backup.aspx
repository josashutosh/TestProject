<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login-backup.aspx.cs" Inherits="EsquareMasterTemplate.Login" %>
...
<head runat="server">
    ...
    <link href="ThemeAssets/admin/pages/css/login.css" rel="stylesheet" type="text/css" />
    ...
    <link href="ThemeAssets/admin/layout/css/themes/default.css" rel="stylesheet" id="style_color"
        type="text/css" />
...
<body class="login">
    ...
    <div class="logo">
        <a href="index.html">
            <img src="ThemeAssets/admin/layout/img/logo-big.png" alt="" />
        </a>
    </div>
    <!-- END LOGO -->
    <!-- BEGIN LOGIN -->
    ...
    <div class="content">
        ...
        <div class="login-form">
            ...
            <div class="form-group">
                ...
                <asp:TextBox class="form-control form-control-solid placeholder-no-fix" autocomplete="off"
                    ID="txtUsername" placeholder="Username" runat="server"></asp:TextBox>
            </div>
            <div class="form-group">
                <label class="control-label visible-ie8 visible-ie9">
                    Password</label>
            ...
            <div class="form-actions">
               <asp:Button ID="btnLogin" class="btn btn-success uppercase" runat="server" 
                    Text="Login" onclick="btnLogin_Click" />
                <label class="rememberme check"></label>
                    <asp:CheckBox ID="chkloginrememberMe" Text="Remember" runat="server" /> 
            ...
            <div class="login-options">
                ...
                <ul class="social-icons">
                    ...
                    <li><a class="social-icon-color googleplus" data-original-title="Goole Plus" href="#">
                    </a></li>
        ...
        <div class="forget-form">
            ...
            <div class="form-group">
                    <asp:TextBox class="form-control placeholder-no-fix" autocomplete="off" placeholder="Email" ID="txtFpId" runat="server"></asp:TextBox>
            </div>
            <div class="form-actions">
        ...
        <div class="register-form">
            ...
            <div class="form-group">
                <label class="control-label visible-ie8 visible-ie9">
                    Username</label>
                <asp:TextBox ID="TextBox1" class="username form-control placeholder-no-fix" placeholder="Username"
                    runat="server"></asp:TextBox>
            </div>
            <div class="form-group">
                <label class="control-label visible-ie8 visible-ie9">
                    Password</label>
                <asp:TextBox ID="txtPassword" autocomplete="off" TextMode="Password" class="Password form-control placeholder-no-fix"
                    placeholder="Password" runat="server"></asp:TextBox>
            </div>
            <div class="form-group">
                <label class="control-label visible-ie8 visible-ie9">
                    Re-type Your Password</label>
                <asp:TextBox ID="txtRepass" autocomplete="off" TextMode="Password" class="form-control placeholder-no-fix"
                    placeholder="Re-type Your Password" runat="server"></asp:TextBox>
            </div>
...
<![endif]-->
    ...
    <script src="ThemeAssets/global/plugins/bootstrap-pwstrength/pwstrength-bootstrap.js"
    ...
    <script src="ThemeAssets/global/plugins/uniform/jquery.uniform.min.js" type="text/javascript"></script>
    
    <!-- END CORE PLUGINS -->
    <!-- BEGIN PAGE LEVEL PLUGINS -->
    <script src="ThemeAssets/global/plugins/jquery-validation/js/jquery.validate.min.js"
        type="text/javascript"></script>
    ...
    <script src="ThemeAssets/admin/pages/scripts/logins.js" type="text/javascript"></script>
    ...
    <!-- END PAGE LEVEL SCRIPTS -->
        ...
        jQuery(document).ready(function () {
            ...
            function tostWarn() {
                toastr.warning('The username or password you entered is incorrect.... ');
            }
        });
    </script>
</body>
