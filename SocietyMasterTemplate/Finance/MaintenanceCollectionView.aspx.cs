...
{
    public partial class MaintenanceCollectionView : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Session["LoginType"].ToString() == "SocietyMember")
                {
                    btnCollmaster.Attributes["style"] = "display:none";
                    filtergroup1.Attributes["style"] = "display:none";
                }
        ...
        protected void btndelete_Click(Object sender, EventArgs e)
        {
            ...
            string DeleteClienDetails = objMainCollDAL.DeleteMaintainanceDetail(objMainCollEntity);
        ...
        {
            Response.Redirect("MaintenanceCollection.aspx?PId=" + ViewState["ParentId"].ToString());
        }
